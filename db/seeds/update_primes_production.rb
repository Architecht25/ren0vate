...
begin
  ...
  load Rails.root.join('db', 'seeds', 'flandre', 'primes_flandre.rb')
  puts "✅ Primes Flandre mises à jour"
  
  puts "📋 Chargement des primes Entreprises..."
  load Rails.root.join('db', 'seeds', 'entreprises', 'primes_entreprises.rb')
  puts "✅ Primes Entreprises mises à jour"
...
puts "  🏢 Entreprises: #{Prime.where(region: 'entreprises').count}"