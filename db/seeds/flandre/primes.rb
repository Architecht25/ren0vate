Prime.create!(
  ...
  valeurs_par_categorie: {'4': {'type': 'pourcentage_et_plafond', 'pourcentage': 50, 'plafond': 5750, 'condition': 'isolation et rénovation'}, '3': {'type': 'pourcentage_et_plafond', 'pourcentage': 35, 'plafond': 4025, 'condition': 'isolation et rénovation'}, '2': {'type': 'montant_m2_et_limite', 'montant_m2': 16, 'surface_max': 100, 'plafond_pourcentage': 25, 'condition': 'isolation seule'}, '1': {'type': 'montant_m2_et_limite', 'montant_m2': 8, 'surface_max': 100, 'plafond_pourcentage': 20, 'condition': 'isolation seule'}},
  ...
  specifique: " XX ",
  placeholder: {'1': 'Surface en m²', '2': 'Surface en m²', '3': 'Montant total de la facture', '4': 'Montant total de la facture'},
...
Prime.create!(
  ...
  placeholder: {'1': 'Surface en m²', '2': 'Surface en m²'},
  image: "images/isolation_murs_ext.webp"
)

Prime.create!(
  slug: "isolation_murs_cat34",
  titre: "Isolation des murs extérieurs (cat. 3-4)",
  unite: "€",
  type_de_valeur: "montant_facture",
  region: "flandre",
  eligible_categories: ['3', '4'],
  valeurs_par_categorie: {'4': {'type': 'pourcentage_et_plafond', 'pourcentage': 50, 'plafond': 5000, 'condition': 'isolation et rénovation'}, '3': {'type': 'pourcentage_et_plafond', 'pourcentage': 35, 'plafond': 3500, 'condition': 'isolation et rénovation'}},
  condition: "R ≥ 3.0 m²K/W (selon méthode – mur creux: 5 cm de creux et R≥ 2, intérieur:2.0 ou extérieur:3.0)",
  conseil: "Vérifiez les ponts thermiques, choisissez la méthode adaptée (spouwmuur, intérieur, extérieur).",
  document: "Facture + devis ou métré + attestation de l’entrepreneur. si isolation par l'intérieur, alors attestation de l'entrepreneur, il faut un architecte ou un entrepreneur avec numéro BIM.",
  specifique: "Si isolation par murs creux/en coulisse - attestation STS et numéro STS présent dans la facture",
  placeholder: {'3': 'Montant total de la facture', '4': 'Montant total de la facture'},
  image: "images/isolation_murs_ext.webp"
)
...
Prime.create!(
  ...
  region: "flandre",
  eligible_categories: ['1', '2', '3', '4'],
  valeurs_par_categorie: {'4': {'type': 'pourcentage_et_plafond', 'pourcentage': 50, 'plafond': 1500, 'condition': 'isolation et rénovation'}, '3': {'type': 'pourcentage_et_plafond', 'pourcentage': 35, 'plafond': 1050, 'condition': 'isolation et rénovation'}, '2': {'type': 'montant_m2_et_limite', 'montant_m2': 9, 'surface_max': 75, 'plafond_pourcentage': 25, 'condition': 'isolation seule'}, '1': {'type': 'montant_m2_et_limite', 'montant_m2': 6, 'surface_max': 75, 'plafond_pourcentage': 20, 'condition': 'isolation seule'}},
...
Prime.create!(
  slug: "voorbereiding_isolatie",
  titre: "Travaux préparatoires pour l’isolation",
  unite: "€",
  type_de_valeur: "facture",
  region: "flandre",
  eligible_categories: ['3', '4'],
  valeurs_par_categorie: {'4': {'type': 'pourcentage_et_plafond', 'pourcentage': 50, 'plafond': 2000, 'condition': "Travaux préparatoires en vue d'une isolation – uniquement si la prime isolation est demandée"}, '3': {'type': 'pourcentage_et_plafond', 'pourcentage': 35, 'plafond': 1400, 'condition': "Travaux préparatoires en vue d'une isolation – uniquement si la prime isolation est demandée"}, '2': {'type': 'prime_conditionnelle', 'valeur': 0, 'condition': 'Prime complémentaire uniquement si la prime isolation est demandée'}, '1': {'type': 'prime_conditionnelle', 'valeur': 0, 'condition': 'Prime complémentaire uniquement si la prime isolation est demandée'}},
  ...
  specifique: " XX ",
  placeholder: {'1': '', '2': '', '3': 'Montant total de la facture', '4': 'Montant total de la facture'},
  image: "images/preparation_isolation.webp"
)

Prime.create!(
  slug: "voorbereiding_sanitair_elec",
  titre: "Travaux préparatoires sanitaires et électricité",
  unite: "€",
  type_de_valeur: "facture",
  region: "flandre",
  eligible_categories: ['3', '4'],
  valeurs_par_categorie: {'4': {'type': 'pourcentage_et_plafond', 'pourcentage': 50, 'plafond': 3000}, '3': {'type': 'pourcentage_et_plafond', 'pourcentage': 35, 'plafond': 2100}},
...
Prime.create!(
  ...
  region: "flandre",
  eligible_categories: ['1', '2', '3', '4'],
  valeurs_par_categorie: {'4': {'type': 'forfait_et_plafond_facture', 'forfaits': {'geothermique': 8000, 'air_eau': 6000, 'air_air': 600, 'hybride': 4000}, 'plafond_pourcentage': 50}, '3': {'type': 'forfait_et_plafond_facture', 'forfaits': {'geothermique': 6000, 'air_eau': 4500, 'air_air': 450, 'hybride': 3000}, 'plafond_pourcentage': 35}, '2': {'type': 'forfait_et_plafond_facture', 'forfaits': {'geothermique': 4000, 'air_eau': 2250, 'air_air': 300, 'hybride': 1500}, 'plafond_pourcentage': 25}, '1': {'type': 'forfait_et_plafond_facture', 'forfaits': {'geothermique': 4000, 'air_eau': 2250, 'air_air': 300, 'hybride': 1500}, 'plafond_pourcentage': 20}},
  ...
  placeholder: {'1': 'Choisissez le type de pompe', '2': 'Choisissez le type de pompe', '3': 'Choisissez le type de pompe', '4': 'Choisissez le type de pompe'},
...
Prime.create!(
  ...
  region: "flandre",
  eligible_categories: ['1', '2', '3', '4'],
  valeurs_par_categorie: {'4': {'type': 'forfait_et_plafond_facture', 'forfait': 1200, 'plafond_pourcentage': 50}, '3': {'type': 'forfait_et_plafond_facture', 'forfait': 1050, 'plafond_pourcentage': 35}, '2': {'type': 'forfait_et_plafond_facture', 'forfait': 900, 'plafond_pourcentage': 25}, '1': {'type': 'forfait_et_plafond_facture', 'forfait': 900, 'plafond_pourcentage': 20}},
  ...
  specifique: " XX ",
  placeholder: {'1': 'Montant total de la facture', '2': 'Montant total de la facture', '3': 'Montant total de la facture', '4': 'Montant total de la facture'},
  image: "images/pac_hybride.webp"
)

Prime.create!(
  slug: "renovation_toiture",
  titre: "Travaux de rénovation associés - Toiture",
  unite: "€",
  type_de_valeur: "dynamique",
  region: "flandre",
  eligible_categories: ['3', '4'],
  valeurs_par_categorie: {'4': {'type': 'pourcentage_et_plafond', 'pourcentage': 50, 'plafond': 5750}, '3': {'type': 'pourcentage_et_plafond', 'pourcentage': 35, 'plafond': 4025}},
  ...
  specifique: " XX ",
  placeholder: {'3': 'Montant total des travaux toiture hors isolation', '4': 'Montant total des travaux toiture hors isolation'},
  image: "images/renovation_toiture.webp"
)

Prime.create!(
  slug: "renovation_murs",
  ...
  specifique: " XX ",
  placeholder: {'3': 'Montant total des travaux murs hors isolation', '4': 'Montant total des travaux murs hors isolation'},
...
Prime.create!(
  ...
  specifique: " XX ",
  placeholder: {'3': 'Montant total des travaux sols hors isolation', '4': 'Montant total des travaux sols hors isolation'},
