...
Prime.find_or_initialize_by(slug: "isolation_toiture").update!(
  ...
  valeurs_par_categorie: JSON.parse('{"4": {"type": "pourcentage_et_plafond", "pourcentage": 50, "plafond": 5750, "condition": "isolation et rénovation"}, "3": {"type": "pourcentage_et_plafond", "pourcentage": 35, "plafond": 4025, "condition": "isolation et rénovation"}}'),
...
Prime.find_or_initialize_by(slug: "isolation_sol").update!(
  ...
  eligible_categories: ["3", "4"],
  valeurs_par_categorie: JSON.parse('{"4": {"type": "pourcentage_et_plafond", "pourcentage": 50, "plafond": 1500, "condition": "isolation et rénovation"}, "3": {"type": "pourcentage_et_plafond", "pourcentage": 35, "plafond": 1050, "condition": "isolation et rénovation"}}'),
...
Prime.find_or_initialize_by(slug: "warmtepomp").update!(
  ...
  valeurs_par_categorie: JSON.parse('{"4": {"type": "forfait_et_plafond_facture", "forfaits": {"geothermique": 8000, "air_eau": 6000, "air_air": 600, "hybride": 4000}, "plafond_pourcentage": 50}, "3": {"type": "forfait_et_plafond_facture", "forfaits": {"geothermique": 6000, "air_eau": 4500, "air_air": 450, "hybride": 3000}, "plafond_pourcentage": 35}, "2": {"type": "forfait_et_plafond_facture", "forfaits": {"geothermique": 4000, "air_eau": 1500, "air_air": 300, "hybride": 800}, "plafond_pourcentage": 25}, "1": {"type": "forfait_et_plafond_facture", "forfaits": {"geothermique": 4000, "air_eau": 1500, "air_air": 300, "hybride": 800}, "plafond_pourcentage": 20}}'),
...
Prime.find_or_initialize_by(slug: "warmtepompboiler").update!(
  ...
  eligible_categories: ["1", "2", "3", "4"],
  valeurs_par_categorie: JSON.parse('{"4": {"type": "forfait_et_plafond_facture", "forfait": 1200, "plafond_pourcentage": 50}, "3": {"type": "forfait_et_plafond_facture", "forfait": 1050, "plafond_pourcentage": 35}, "2": {"type": "forfait_et_plafond_facture", "forfait": 450, "plafond_pourcentage": 25}, "1": {"type": "forfait_et_plafond_facture", "forfait": 450, "plafond_pourcentage": 20}}'),
...
Prime.find_or_initialize_by(slug: "amiante").update!(
  ...
  placeholder: JSON.parse('{"3": "Surface désamiantée en m²", "4": "Surface désamiantée en m²"}'),
