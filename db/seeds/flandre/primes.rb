...
Prime.find_or_initialize_by(slug: "isolation_murs_cat34").update!(
  ...
  unite: "€",
  typeDeValeur: "montant_facture",
  categorieLimite: ["3", "4"],
  eligible_categories: ["3", "4"],
  valeursParCategorie: JSON.parse('{"4": {"type": "pourcentage_et_plafond", "pourcentage": 50, "plafond": 5000, "condition": "isolation et rénovation"}, "3": {"type": "pourcentage_et_plafond", "pourcentage": 35, "plafond": 3500, "condition": "isolation et rénovation"}}'),
  condition: "R ≥ 3.0 m²K/W (selon méthode – mur creux: 5 cm de creux et R≥ 2, intérieur:2.0 ou extérieur:3.0)",
  conseil: "Vérifiez les ponts thermiques, choisissez la méthode adaptée (spouwmuur, intérieur, extérieur).",
  document: "Facture + devis ou métré + attestation de l’entrepreneur. si isolation par l'intérieur, alors attestation de l'entrepreneur, il faut un architecte ou un entrepreneur avec numéro BIM.",
  specifique: "Si isolation par murs creux/en coulisse - attestation STS et numéro STS présent dans la facture",
...
Prime.find_or_initialize_by(slug: "voorbereiding_isolatie").update!(
  ...
  unite: "€",
  typeDeValeur: "facture",
  eligible_categories: ["3", "4"],
  valeursParCategorie: JSON.parse('{"4": {"type": "pourcentage_et_plafond", "pourcentage": 50, "plafond": 2000, "condition": "Travaux préparatoires en vue d'une isolation – uniquement si la prime isolation est demandée"}, "3": {"type": "pourcentage_et_plafond", "pourcentage": 35, "plafond": 1400, "condition": "Travaux préparatoires en vue d'une isolation – uniquement si la prime isolation est demandée"}, "2": {"type": "prime_conditionnelle", "valeur": 0, "condition": "Prime complémentaire uniquement si la prime isolation est demandée"}, "1": {"type": "prime_conditionnelle", "valeur": 0, "condition": "Prime complémentaire uniquement si la prime isolation est demandée"}}'),
...
Prime.find_or_initialize_by(slug: "voorbereiding_sanitair_elec").update!(
  ...
  typeDeValeur: "facture",
  eligible_categories: ["3", "4"],
  valeursParCategorie: JSON.parse('{"4": {"type": "pourcentage_et_plafond", "pourcentage": 50, "plafond": 3000}, "3": {"type": "pourcentage_et_plafond", "pourcentage": 35, "plafond": 2100}}'),
...
Prime.find_or_initialize_by(slug: "renovation_toiture").update!(
  ...
  valeursParCategorie: JSON.parse('{"4": {"type": "pourcentage_et_plafond", "pourcentage": 50, "plafond": 5750}, "3": {"type": "pourcentage_et_plafond", "pourcentage": 35, "plafond": 4025}}'),
