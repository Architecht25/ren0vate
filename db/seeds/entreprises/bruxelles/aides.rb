...
# Prime First Job
EntrepriseAide.find_or_create_by(slug: "bruxelles_first_job") do |aide|
  aide.titre = "Prime First Job"
  aide.region = "bruxelles"
  aide.categorie = "recrutement_formation"
  aide.description = "Aide à l'embauche de primo-demandeurs d'emploi"

  aide.montant_min = 3000
  aide.montant_max = 12000
  aide.taux_aide = 100.0 # Montant forfaitaire

  aide.conditions_eligibilite = {
    "profil_recrute" => [
      "Primo-demandeur d'emploi",
      "Inscrit chez Actiris",
      "Contrat CDI ou CDD minimum 6 mois"
    ]
  }
