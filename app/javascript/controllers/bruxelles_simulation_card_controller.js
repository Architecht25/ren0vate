...
export default class extends Controller {
  ...
  calculate() {
    ...
    if (!parentController) {
      console.warn("Controller parent Bruxelles simulation non trouvé")
      return
    }
    ...
    if (!prime) {
      console.warn(`Prime Bruxelles non trouvée pour slug: ${this.slugValue}`)
      this.updateResult(0)
      return
    }
  ...
  getParentController() {
    ...
    if (parentElement) {
      return this.application.getControllerForElementAndIdentifier(parentElement, 'bruxelles-simulation')
    }
    return null
  }
