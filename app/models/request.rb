class Request < ApplicationRecord
  ...
  enum :form_type, {
    ...
    # ENTREPRISES BRUXELLES (14 formulaires correspondant aux partials)
    ...
    consultance_transition_bruxelles: 'consultance_transition_bruxelles',
    investissement_transition_bruxelles: 'investissement_transition_bruxelles',
    mobilite_velo_cargo_bruxelles: 'mobilite_velo_cargo_bruxelles',
    mobilite_utilistaire_electrique_bruxelles: 'mobilite_utilistaire_electrique_bruxelles',
    securisation_bruxelles: 'securisation_bruxelles',
