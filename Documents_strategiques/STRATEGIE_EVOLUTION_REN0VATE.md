...
- ✅ ~~Stripe integration paiements~~ **LIVRÉ 27/04/2026 — v820 LIVE** — checkout, webhooks (6 events), subscription sauvée en DB, clés live sur Heroku
...
- ✅ ~~Collaboration basique (inviter pros)~~ **LIVRÉ 27/03/2026 — ProjectMember, invitations token, pro_view par rôle (entrepreneur/architecte), onboarding**
- ✅ ~~Notifications email automatiques~~ **LIVRÉ 27/03/2026 — NotificationMailer, after_create_commit, 10 types de notifs envoyés par email**
