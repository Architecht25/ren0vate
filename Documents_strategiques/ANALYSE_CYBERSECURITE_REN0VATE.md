...
| Données sensibles en clair en BDD | 🟠 | Revenus, IBAN partiels, données fiscales — chiffrement at-rest à envisager |
...
- [ ] **Chiffrement at-rest des données fiscales sensibles** — revenus, statuts BIM/RIS en BDD
