# Configuration pour WickedPDF - DÉSACTIVÉE
# Note: Utilisation d'une solution PDF alternative sans buildpack externe

# Configuration historique (conservée pour référence)
if false # Désactivé temporairement
  ...
  # Configuration Rails pour inclure WickedPDF - DÉSACTIVÉE
  # Rails.application.config.middleware.use WickedPdf::Middleware
end

# Configuration alternative : PdfGenerationService
# Les exports PDF utilisent maintenant une solution HTML print-friendly
# sans dépendance externe (voir app/services/pdf_generation_service.rb)
