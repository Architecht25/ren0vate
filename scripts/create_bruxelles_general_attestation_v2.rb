#!/usr/bin/env ruby
# Script pour créer l'attestation générale unique pour Bruxelles (SANS prime associée)
# Usage: rails runner scripts/create_bruxelles_general_attestation_v2.rb
...
if DRY_RUN
  ...
  puts "   Pour exécuter réellement: DRY_RUN=false rails runner scripts/create_bruxelles_general_attestation_v2.rb"
else
...
# Vérifier si l'attestation générale existe déjà (sans prime associée)
...
unless DRY_RUN
  ...
  if final_attestation
    ...
    puts "   Prime associée: #{final_attestation.prime.nil? ? 'AUCUNE (général)' : final_attestation.prime.titre}"
...
if DRY_RUN
  ...
  puts "- Prime associée: AUCUNE (vraiment générale!)"
else
  puts "✅ Attestation générale Bruxelles configurée avec succès!"
  puts "   Cette attestation apparaîtra pour TOUTES les simulations Bruxelles"
  puts "   car elle n'est liée à aucune prime spécifique."
end
...
if DRY_RUN
  ...
  puts "   DRY_RUN=false rails runner scripts/create_bruxelles_general_attestation_v2.rb"
end
